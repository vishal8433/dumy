...
<body>
    ...
    <nav class="navbar navbar-toggleable-md navbar-light  bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ml-auto">
                <li class="nav-item item1 active"><a href="contacts.php">
                        <button class="contactbtn btn-outline-success my-2 my-sm-0" type="submit"><b>Developer</b></button></a>
                </li>
    ...
    <div class="fluid-container midportion">
        <div class="fluid-container landingbtn">
            <a href="district_list.php"><button type="button" class="btncs btn-lg"><b>Search your Hospital</b></button></a>
            <a href="https://www.covid19india.org/"><button type="button" class="btncs1 btn-lg"><b>Covid-19 Updates</b></button></a>
        </div>
    </div>
    <footer>
