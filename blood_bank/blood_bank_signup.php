...
<html>
<head>
    <title>Sanjeevni.com/bood_bank_sign_up_page</title>
    <!--required meta tag-->
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="../style/blood_bank_signup_stylesheet.css">
                ...
                <div class="row maincontainer">
                    <div class="container-fluid contactform">
                        <div class="contact-title">
                            <h1 class="signupline"><b>Blood Bank Sign up</b></h1>
                        ...
                        <div class="contact-form">
                            <form action="" method="post">
                                ...
                                <input name="b_b_name" type="text" class="form-control" placeholder="Hospital Name" autocomplete="off" required><br>
                                ...
                                <input name="b_b_phone_no" type="text" class="form-control" placeholder="Hospital Phone Number" autocomplete="off" required><br>
                                <select name="a_positive" class="form-control">
                                    <option>A+ Blood Group</option>
                                    <option>Yes</option>
                                    <option>No</option>
                                </select><br>
                                <select name="a_negative" class="form-control">
                                    <option>A- Blood Group</option>
                                    <option>Yes</option>
                                    <option>No</option>
                                </select><br>
                                <select name="b_positive" class="form-control">
                                    <option>B+ Blood Group</option>
                                    <option>Yes</option>
                                    <option>No</option>
                                </select><br>
                                <select name="b_negative" class="form-control">
                                    <option>B- Blood Group</option>
                                    <option>Yes</option>
                                    <option>No</option>
                                </select><br>
                                <select name="ab_positive" class="form-control">
                                    <option>AB+ Blood Group</option>
                                    <option>Yes</option>
                                    <option>No</option>
                                </select><br>
                                <select name="ab_negative" class="form-control">
                                    <option>AB- Blood Group</option>
                                    <option>Yes</option>
                                    <option>No</option>
                                </select><br>
                                <select name="o_positive" class="form-control">
                                    <option>O+ Blood Group</option>
                                    <option>Yes</option>
                                    <option>No</option>
                                </select><br>
                                <select name="O_negative" class="form-control">
                                    <option>O- Blood Group</option>
                                    <option>Yes</option>
                                    <option>No</option>
                                </select><br>
                        ...
                        <?php include('blood_bank_signup_script.php'); ?>
                    </div>
                </div>
            </div>
        </div>  
