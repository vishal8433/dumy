        ...
        <div class="col-sm-12">
            <div class="col1">
                <?php
                                            ...
                                            $users="SELECT * FROM `blood_donor` ";
                                            $run_user=mysqli_query($con,$users);
                                                echo"<h1 style='color:white; text-align:center; font-family:sans-serif;'>Blood Donor users</h1><hr>";
                                            while($row_user=mysqli_fetch_array($run_user)){
                                                $u_id=$row_user['id'];
                                                $email=$row_user['email'];
                                                echo"<a class='name' href='admin_blood_donor_profile.php?id=$u_id' >$email</a><hr>";
                                            }
                                            ?>
            </div>
        </div>
