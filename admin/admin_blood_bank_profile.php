...
if(isset($_GET['id'])){
    $u_id=$_GET['id'];
    $vj="SELECT * FROM `blood_bank` WHERE `id`='$u_id'";
        ...
        <div class="row">
           <div class="col-sm-12">
            <div class="col1">
                ...
                <h1 class="info"><i>blood bank name</i> : <?php echo"$name";?></h1><hr>
                <h1 class="info"><i>address</i> : <?php echo"$address";?></h1><hr>
                <h1 class="info"><i>phone no.</i> : <?php echo"$phone_no";?></h1><hr>
                ...
                <h1 class="info"><i>a+</i> : <?php echo"$a_positive";?></h1><hr>
                <h1 class="info"><i>a-</i> : <?php echo"$a_negative";?></h1><hr>
                <h1 class="info"><i>b+</i> : <?php echo"$b_positiveb";?></h1><hr>
                <h1 class="info"><i>b-</i> : <?php echo"$b_negative";?></h1><hr>
                <h1 class="info"><i>AB+</i> : <?php echo"$ab_positive";?></h1><hr>
                <h1 class="info"><i>AB-</i> : <?php echo"$ab_negative";?></h1><hr>
                <h1 class="info"><i>o+</i> : <?php echo"$o_positive";?></h1><hr>
                <h1 class="info"><i>o-</i> : <?php echo"$o_negative";?></h1><hr>
                <h1 class="info"><i>last updated on</i> : <?php echo"$reg_date";?></h1><hr>
                <h1 class="info"><i>status</i> : <?php echo"$status";?></h1><hr>
                    <div class="row">
                    <div class="col-sm-12">
                        <div class="col2">
                             <?php echo"<a style='color:white; text-decoration:none;' href='delete_blood_bank_script.php?id=$u_id'><button type='submit' class='btn btn-lg btn-block deletea'>Delete Account</button></a>"; ?>
                        </div>
                    </div>
                </div>
            </div>
